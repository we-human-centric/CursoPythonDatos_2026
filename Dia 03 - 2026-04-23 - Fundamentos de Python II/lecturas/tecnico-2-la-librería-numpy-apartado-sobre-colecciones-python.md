# La librería NumPy (apartado sobre colecciones Python)

Fuente: [Aprende con Alf](https://aprendeconalf.es/docencia/python/manual/numpy/)  
...
Última actualización el May 12, 2022
